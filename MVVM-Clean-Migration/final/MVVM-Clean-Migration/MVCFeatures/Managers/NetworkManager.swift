...
public class NetworkRequest {
    public static func request<T: Codable>(path: String, method: HTTPMethod, parameters: [String: Any]? = nil, responseObject: T.Type, showProgress: Bool = true, completion: @escaping (APIResult<T>) -> Void) {
        var dataResult = Data()
        if path == "ShopperAuth" {
